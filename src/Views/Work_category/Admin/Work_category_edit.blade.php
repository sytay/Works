...
@section('title')
Admin area: {{ trans('site:work_category_admin.page_edit') }}
@stop
@section('content')
<div class="row">
    <div class="col-md-12">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title bariol-thin">
                        {!! !empty($category->category_id) ? '<i class="fa fa-pencil"></i>'.trans('site:work_category_admin.form_edit') : '<i class="fa fa-users"></i>'.trans('site:work_category_admin.form_add') !!}
                    </h3>
                </div>
                <!-- ERRORS NAME  -->
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            ...
                            <h4>{!! trans('work::site_admin.form_heading') !!}</h4>
                            {!! Form::open(['route'=>['admin_work_category.post', 'id' => @$category->category_id],  'files'=>true, 'method' => 'post'])  !!}
